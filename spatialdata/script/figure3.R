...
data=readRDS("../data/fig3a_group_assignment.rds")
data <- data |>
  group_by(groups) 
...
diff_rds=readRDS("../data/fig3bc_umap_data.rds")
...
data=readRDS("../data/fig3d_feature_counts.rds")
...
cornetworkplot=readRDS("../data/fig3ef_correlation_networks.rds")
