...
## How to Reproduce
The scripts to reproduce the figures (3-4) are located in "spatialdata/". You can run "figure3.R" and "figure4.R" locally. Note that original scripts use the relative path "./data/".
