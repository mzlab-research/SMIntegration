...
SMIntegration is cross-platform. It is web-based (compatible with Chrome, Firefox, Edge, and Safari) and supports local deployment via either Docker or a native R (Shiny) environment. For users who wish to run SMIntegration locally via R:
