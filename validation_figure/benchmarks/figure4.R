...
data=readRDS("./Figures/rds/CA-vs-PAG/plotdata_group.rds")
data <- data |>
  group_by(groups) 
...
pdf("./Figures/4a.pdf", width = 4, height = 6)
print(p1)
dev.off()
#4b---------------------------------------------------------------------------------------
...
data=readRDS("./Figures/rds/CA-vs-PAG/data_count_long_all.rds")
...
pdf("./Figures/4b.pdf", width = 6, height = 6)
print(p2)
dev.off()
...
CairoPDF("./Figures/4c.pdf", width = 6, height = 6 ,family = "Arial")
grid.draw(p3)
dev.off()
...
pdf("./Figures/4d.pdf", width = 8, height = 6) 
print(g)
dev.off()
#4e---------------------------------------------------------------------------------------
...
output_file <-  file.path("./Figures",  "4e.pdf")
target_width <- 5  
target_height <- 6  
dpi <- 300  
...
annotation_plotdata=readRDS("./Figures/rds/CA-vs-PAG/PAG/Retrograde endocannabinoid signaling/annotation_plotdata.RDS")
data_rds=readRDS("./Figures/rds/data_rds.rds")
...
runplot <- function(feature, meta.data, counts, size = 1, featurename = NULL, anno_name = NULL) {
  ...
  pdf("./Figures/4f.pdf", width = 10, height = 6)
  ...
  # pdf("./Figures/4f-2.pdf", width = 8, height = 6)
  ...
  pdf("./Figures/4g.pdf", width = 10, height = 6)
